...
imshow(uint8(squeeze(X_miss(1,1,:,:))))
subplot(2,6,8)
imshow(uint8(squeeze(X_miss(1,14,:,:))))
subplot(2,6,9)
imshow(uint8(squeeze(X_miss(5,1,:,:))))
subplot(2,6,10)
imshow(uint8(squeeze(X_miss(10,7,:,:))))
subplot(2,6,11)
imshow(uint8(squeeze(X_miss(8,11,:,:))))
subplot(2,6,12)
imshow(uint8(squeeze(X_miss(11,11,:,:))))
